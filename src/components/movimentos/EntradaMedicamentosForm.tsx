...
import { Button, Card, Form, Row, Col, Table, Toast, ToastContainer } from 'react-bootstrap';
...
const EntradaMedicamentosForm: React.FC<EntradaMedicamentosFormProps> = ({
  ...
  const adicionarItem = () => {
    ...
    setToastMessage(`${medicamento?.principioAtivo || 'Medicamento'} adicionado com sucesso!`);
    setShowToast(true);
  ...
  return (
    <>
      ...
      {/* Toast Notification */}
      <ToastContainer position="bottom-center" className="p-3" style={{ zIndex: 1, top: "200px" }}>
        <Toast 
