...
import {
  ...
  useWillUnmount,
  useWindow
} from "./chunk-VCP7UXG7.js";
import {
  Button_default as Button_default2
} from "./chunk-QY4OLXOW.js";
import {
  CardBody_default,
  CardFooter_default,
  ...
  CardTitle_default,
  Card_default
} from "./chunk-ZSRXEOEM.js";
import {
  Container_default
} from "./chunk-S4A6VXTA.js";
import {
  Row_default
} from "./chunk-NYPW3RRO.js";
import {
  ...
  map,
  require_warning
} from "./chunk-LBBQEBZ7.js";
import {
  Col_default,
  useCol
} from "./chunk-PVDK6SV7.js";
import {
...
import {
  ...
  useMounted,
  usePrevious
} from "./chunk-K4OVXDL4.js";
import {
  Button_default
} from "./chunk-TTLMHYJO.js";
import {
  divWithClassName_default
} from "./chunk-VYABZWZZ.js";
import {
  require_prop_types
...
function useForceUpdate() {
  const [, dispatch] = (0, import_react12.useReducer)((revision) => revision + 1, 0);
  return dispatch;
}
...
function useDropdownMenu(options = {}) {
  const context5 = (0, import_react16.useContext)(DropdownContext_default);
...
function Dropdown({
  ...
  const context5 = (0, import_react20.useMemo)(() => ({
    toggle,
    placement,
    show,
    menuElement,
...
var NavItem = React43.forwardRef((_ref, ref) => {
  ...
  return (0, import_jsx_runtime37.jsx)(Component2, Object.assign({}, options, props, {
    ref
  }));
});
...
var Nav = React44.forwardRef((_ref, ref) => {
  ...
  return (0, import_jsx_runtime38.jsx)(SelectableContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime38.jsx)(NavContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime38.jsx)(Component2, Object.assign({}, props, {
        onKeyDown: handleKeyDown,
        ref: mergedRef,
        role
      }))
...
var NavbarCollapse = React51.forwardRef(({
  ...
  const context5 = (0, import_react30.useContext)(NavbarContext_default);
...
var Offcanvas = React57.forwardRef(({
  ...
  const renderBackdrop = (0, import_react34.useCallback)((backdropProps) => (0, import_jsx_runtime51.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React58.forwardRef(({
  ...
  const context5 = (0, import_react35.useContext)(NavbarContext_default);
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime68.jsxs)(import_jsx_runtime67.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react41.cloneElement)(children, triggerProps), (0, import_jsx_runtime66.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var Pagination = React71.forwardRef(({
  ...
  return (0, import_jsx_runtime71.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames50.default)(className, decoratedBsPrefix, size && `${decoratedBsPrefix}-${size}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames51.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size && `${bsPrefix}-${size}`, bg && `bg-${bg}`)
  };
}
...
var Spinner = React76.forwardRef(({
  ...
  return (0, import_jsx_runtime76.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames54.default)(className, bsSpinnerPrefix, size && `${bsSpinnerPrefix}-${size}`, variant && `text-${variant}`)
  });
});
...
function useTabPanel(_ref) {
  ...
  const {
    ...
    getControlledId,
    getControllerId
  } = context5, rest = _objectWithoutPropertiesLoose6(context5, _excluded22);
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime85.jsx)(NavItem_default2, {
    as: "li",
    role: "presentation",
...
var ToastFade = React84.forwardRef((props, ref) => (0, import_jsx_runtime87.jsx)(Fade_default, {
  ...props,
  ref,
